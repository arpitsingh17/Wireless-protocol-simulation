...
time0 = time1[0]
timen = time1[-1]
throughput0=(r11/(float(float(timen)-float(time0))*1000))*8
throughput1=(r00/(float(float(timen)-float(time0))*1000))*8
...
print "average user throughput", (int(throughput1+throughput0)/2)
print "network throughput" ,(throughput0 + throughput1)
