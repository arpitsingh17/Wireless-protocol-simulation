...
throughput0=((sent00/5.477623333)/1000)*8
throughput2=((sent22/5.448338522)/1000)*8
...
print "throughput of User 0 in kbps :",throughput0
print"throughput of user 1 :0"
print"throughput of user 2 in kbps:",throughput2
print"nt_th :",nt_th